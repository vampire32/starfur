...
const Contact2 = () => {
	...
	return (
		...
		<div className=" bg-white text-black px-8 py-12" data-aos="fade-up">
			<div className="text-center w-full">
				<h3 className=" text-[#d9c7a4] font-extrabold text-[2.5rem]">
					Get In Touch
				</h3>
				<p>
					If you have any Queries | Complaint | Suggestions regarding anything.
					<br />
